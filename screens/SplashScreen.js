        ...
        >
            ...
            <TouchableOpacity onPress={()=>navigation.navigate('SignInScreen')}>
                <LinearGradient
                    ...
                    style={styles.signIn}
                >
                    <Text style={styles.textSign}>Get Started For Customer</Text>
                    <MaterialIcons 
                        name="navigate-next"
                        color="#fff"
                        size={18}
            ...
            <TouchableOpacity onPress={()=>navigation.navigate('SignInOwnerScreen')}>
                <LinearGradient
                    colors={['#35A3A8', '#35A3A8']}
                    style={styles.signIn1}
                >
                    <Text style={styles.textSign1}>Get Started For Owner</Text>
                    <MaterialIcons 
                        name="navigate-next"
                        color="#fff"
                        size={18}
